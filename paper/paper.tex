...
\begin{abstract}
    ...
    d3.js framework was used to develop this visualization. The result can be 
    consulted on tankske.github.io/InfoVisNBA/.
\end{abstract}
...
The \nameref{sec:lessonslearned} section describes some interesting lessons we have learned from the project and in the \nameref{sec:futurework} section we discuss potential  improvements of the final visualization. We reflect on our work in the  
