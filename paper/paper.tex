...
\todo{reference to sections should use the name and not a number because the numbers are not shown, so they are not usable}
...
fivethirtyeight~\cite{fivethirtyeight}. They calculated an ELO-score \todo{explanation of the elo score?} for all
