...
\paragraph{The bubble view} 
A compact view on the play-offs per season.
\paragraph{The statistics (zoom) view} 
A more detailed view on a statistic of a selected 
team.
\paragraph{The team view} 
A detailed view on how good or bad a team scores on a specific 
field position. \\
\newline
...
\paragraph{Context section} 
The top part informs the user about the shown context.
\paragraph{Arrow section} 
This section illustrates why a statistic changed.
\paragraph{Small multiples section} 
...
the play-offs during that season, as ecplained in the bubble view section. When changing teams and/or season, this view gets 
...
To create the visualization, the d3 javascript framework~\cite{d3.js} was used in combination with html5~\cite{html5} and jquery~\cite{jquery}. This allows easy
...
\begin{itemize}
    \item find a use case as soon as possible to built your visualization around
